...
public class SpyAcademyGrader {
    ...
    private static void testReverseString() {
        ...
        testCase("reverseString(\"AGENT\")", "TNEGА", 
    ...
    private static void testCaesarShift() {
        ...
        testCase("caesarShift(\"AGENT\", 5)", "FLMJS", 
    ...
    private static void testCaesarDecrypt() {
        ...
        testCase("caesarDecrypt(\"FLMJS\", 5)", "AGENT", 
                 SpyAcademy.caesarDecrypt("FLMJS", 5));
    ...
    private static void testCaesarShiftPhrase() {
        ...
        testCase("caesarShiftPhrase(\"TOP SECRET!!\", 7)", "AVW ZJJYLA!!", 
        ...
        testCase("caesarShiftPhrase(\"YES-OR-NO?\", 10)", "IOC-BE-XY?", 
    ...
    private static void testCaesarDecryptPhrase() {
        ...
        testCase("caesarDecryptPhrase(\"AVW ZJJYLA!!\", 7)", "TOP SECRET!!", 
                 SpyAcademy.caesarDecryptPhrase("AVW ZJJYLA!!", 7));
